package com.project.emrald.utils;
...
public class Utils {
	...
	public static String generateRandomConfirmationCode(Integer length) {
	...
	public static UserDTO mapUserEntityToUserDTOPlusUserBookingsAndRooms (User user) {
		...
		if(!user.getBookings().isEmpty()) {
			userDTO.setBookings(user.getBookings().stream()
					.map(booking -> mapBookingEntityToBookingDTOPlusBookedRooms(booking, false)).collect(Collectors.toList()));
		}
